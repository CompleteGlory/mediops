...
part of 'client_register_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClientRegisterState<T>);
}
...
/// @nodoc
class $ClientRegisterStateCopyWith<T,$Res>  {
$ClientRegisterStateCopyWith(ClientRegisterState<T> _, $Res Function(ClientRegisterState<T>) __);
}


/// Adds pattern-matching-related methods to [ClientRegisterState].
extension ClientRegisterStatePatterns<T> on ClientRegisterState<T> {
...
class _Initial<T> implements ClientRegisterState<T> {
  const _Initial();
...
@override
String toString() {
  return 'ClientRegisterState<$T>.initial()';
}
...
class _Loading<T> implements ClientRegisterState<T> {
  const _Loading();
...
@override
String toString() {
  return 'ClientRegisterState<$T>.loading()';
}
...
class _Success<T> implements ClientRegisterState<T> {
  const _Success(this.data);
  

 final  T data;

/// Create a copy of ClientRegisterState
...
@override
String toString() {
  return 'ClientRegisterState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $ClientRegisterStateCopyWith<T, $Res> {
...
class _Failure<T> implements ClientRegisterState<T> {
...
@override
String toString() {
  return 'ClientRegisterState<$T>.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<T,$Res> implements $ClientRegisterStateCopyWith<T, $Res> {
