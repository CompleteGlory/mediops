...
part of 'clinic_register_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ClinicRegisterState<T>);
}
...
/// @nodoc
class $ClinicRegisterStateCopyWith<T,$Res>  {
$ClinicRegisterStateCopyWith(ClinicRegisterState<T> _, $Res Function(ClinicRegisterState<T>) __);
}


/// Adds pattern-matching-related methods to [ClinicRegisterState].
extension ClinicRegisterStatePatterns<T> on ClinicRegisterState<T> {
...
class _Initial<T> implements ClinicRegisterState<T> {
  const _Initial();
...
@override
String toString() {
  return 'ClinicRegisterState<$T>.initial()';
}
...
class _Loading<T> implements ClinicRegisterState<T> {
  const _Loading();
...
@override
String toString() {
  return 'ClinicRegisterState<$T>.loading()';
}
...
class _Success<T> implements ClinicRegisterState<T> {
  const _Success(this.data);
  

 final  T data;

/// Create a copy of ClinicRegisterState
...
@override
String toString() {
  return 'ClinicRegisterState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $ClinicRegisterStateCopyWith<T, $Res> {
...
class _Failure<T> implements ClinicRegisterState<T> {
...
@override
String toString() {
  return 'ClinicRegisterState<$T>.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<T,$Res> implements $ClinicRegisterStateCopyWith<T, $Res> {
